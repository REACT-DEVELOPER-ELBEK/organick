          ...
          <div className="home__wrapper">
            <div className="home__banner">
              <div className="home__banner__content">
                ...
                <Link href="/">
                  Explore now <img src="home-banner-button-arrow.svg" alt="" />
                </Link>
              </div>
              <div className="home__banner__img">
                <img src="home-banner-main.png" alt="" />
              </div>
            </div>
              ...
              <div className="product__items">
                ...
                <button>
                  ...
                  <svg
                    ...
                    fill="none"
                  >
                    <circle cx="9.68066" cy="9.5" r="9.5" fill="#335B6B" />
                    <path
                      d="M9.65708 6.12891L13.0516 9.19342L9.65708 12.2579M12.5802 9.19342H5.69678"
                      stroke="white"
                      strokeLinecap="round"
